...
<div class="heading" style="background:url(gambar/header-3.png)no-repeat">
    <h1> book now </h1>
</div>
...
<section class="booking"> 
    ...
    <form action="book_form.php" method="post" class="book-form">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span> address:</span>
                <input type="text" placeholder="enter your address" address="">
            </div>

            <div class="inputBox">
                <span> where to :</span>
                <input type="text" placeholder="palce your want to visit" name="location">
            </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> ldytravelnusantara@gmail.com</a>
            <a href="#"> <i class="fas fa-map"></i> Yogyakarta, Indonesia - 55190</a>
        </div>
